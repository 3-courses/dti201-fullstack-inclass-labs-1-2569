# Lab 01 — เริ่มต้น Course Book Explorer: เว็บทำงานอย่างไร และ repo สะอาดเป็นอย่างไร

## เป้าหมายของคาบนี้

เป้าหมายในคาบแรก คือให้ทุกคนเห็นภาพว่าเว็บแอปทำงานเป็นชั้น ๆ และเริ่ม repo สำหรับโปรเจกต์ฝึกชื่อ **Course Book Explorer**

โปรเจกต์นี้จะใช้เวลาพัฒนาไปตลอดทั้งภาคเรียน จากหน้าเว็บหนังสือธรรมดา ไปเป็น full-stack app ที่มี API, database, deployment และ learning dataset
